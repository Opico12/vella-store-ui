                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 text-center md:text-left">
                    <div className="sm:col-span-2 lg:col-span-1 flex flex-col items-center text-center md:items-center md:text-center">
                        ...
                        <div className="mt-6 flex items-center justify-center gap-2">
                            ...
                            <span className="text-xs font-bold text-green-500 uppercase">Tienda Segura SSL</span>
                        </div>
                    </div>
                    ...
                    <div>
                     ...
                     <div>
                        ...
                        <h3 className="text-base font-bold tracking-widest uppercase mb-4 text-white">Pagos Seguros</h3>
                        <div className="flex justify-center md:justify-start space-x-2 bg-white/10 p-2 rounded-lg backdrop-blur-sm">
                            <VisaIcon />
                            <MastercardIcon />
                            <PayPalIcon />
                            <GooglePayIcon />
