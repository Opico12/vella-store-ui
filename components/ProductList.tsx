...
const ProductList: React.FC<{
    ...
    return (
        <div className="space-y-16">
            ...
            {/* MOVIDO ARRIBA: Sección del Catálogo Interactivo para máxima visibilidad */}
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-10">
                <div className="bg-white rounded-2xl shadow-xl border border-fuchsia-100 p-6 md:p-8">
